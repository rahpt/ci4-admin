...
<div class="main">
            ...
            <ul class="navbar-nav navbar-align">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="/assets/admin/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle"
                                             alt="Vanessa Tucker">
                                    </div>
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="/assets/admin/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle"
                                             alt="William Harris">
                                    </div>
                                    <div class="col-10 ps-2">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="/assets/admin/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle"
                                             alt="Christina Mason">
                                    </div>
                                    <div class="col-10 ps-2">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="/assets/admin/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle"
                                             alt="Sharon Lessman">
                                    </div>
                                    <div class="col-10 ps-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                        <img src="/assets/admin/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall"/>
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img src="/assets/admin/img/avatars/avatar-4.jpg" alt="Christina Mason"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="/assets/admin/img/avatars/avatar-5.jpg" width="36" height="36" class="rounded-circle me-2"
                                     alt="Vanessa Tucker">
                            ...
                            <hr/>
                            <div class="d-flex align-items-start">
                                <img src="/assets/admin/img/avatars/avatar.jpg" width="36" height="36" class="rounded-circle me-2"
                                     alt="Charles Hall">
                                <div class="flex-grow-1">
                            ...
                            <hr/>
                            <div class="d-flex align-items-start">
                                <img src="/assets/admin/img/avatars/avatar-4.jpg" width="36" height="36" class="rounded-circle me-2"
                                     alt="Christina Mason">
                                <div class="flex-grow-1">
                            ...
                            <hr/>
                            <div class="d-flex align-items-start">
                                <img src="/assets/admin/img/avatars/avatar-2.jpg" width="36" height="36" class="rounded-circle me-2"
                                     alt="William Harris">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="row g-0 mt-1">
                                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                            <img src="/assets/admin/img/photos/unsplash-1.jpg" class="img-fluid pe-2" alt="Unsplash">
                                        </div>
                                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                            <img src="/assets/admin/img/photos/unsplash-2.jpg" class="img-fluid pe-2" alt="Unsplash">
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-start mt-1">
                                        <a class="pe-3" href="#">
                                            <img src="/assets/admin/img/avatars/avatar-4.jpg" width="36" height="36"
    ...
    <?= $this->include('\Admin\Views\partials\footer'); ?>
</div>
<?= $this->endSection() ?>